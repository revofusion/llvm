...
__m256d test_mm256_insertf128_pd(__m256d A, __m128d B) {
  ...
  // LLVM: shufflevector <2 x double> %{{.*}}, <2 x double> {{(poison|zeroinitializer)}}, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
__m256i test_mm256_insertf128_si256(__m256i A, __m128i B) {
  ...
  // LLVM: shufflevector <4 x i32> %{{.*}}, <4 x i32> {{(poison|zeroinitializer)}}, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
