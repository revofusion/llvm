...
// CIR: cir.func {{.*}} @foo(%arg{{[0-9]+}}: !cir.ptr<!s32i, target_address_space(1)>
...
// CIR: cir.func {{.*}} @bar(%arg{{[0-9]+}}: !cir.ptr<!s32i, target_address_space(0)>
...
// CIR: cir.func {{.*}} @baz(%arg{{[0-9]+}}: !cir.ptr<!s32i>
