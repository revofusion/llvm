...
// CIR: cir.global external @array = #cir.const_array<[#cir.global_view<@"[[STR]]">, #cir.global_view<@"[[STR1]]">, #cir.global_view<@"[[STR2]]">, #cir.global_view<@"[[STR3]]">, #cir.global_view<@"[[STR4]]">]> : !cir.array<!cir.ptr<!s8i> x 5> {{.*}}
...
// CIR: cir.global external @zeroPadding = #cir.const_array<[#cir.int<104>, #cir.int<105>], trailing_zeros> : !cir.array<!u32i x 20> {{.*}}
