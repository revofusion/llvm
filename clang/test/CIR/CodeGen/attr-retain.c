...
// CIR: cir.global "private" appending @llvm.used = #cir.const_array<[#cir.global_view<@c0>, #cir.global_view<@f0>, #cir.global_view<@f2>, #cir.global_view<@g0>, #cir.global_view<@g1>, #cir.global_view<@g3>]> : !cir.array<!cir.ptr<!void> x 6>
// CIR: cir.global "private" appending @llvm.compiler.used = #cir.const_array<[#cir.global_view<@f2>, #cir.global_view<@g3>]> : !cir.array<!cir.ptr<!void> x 2>
