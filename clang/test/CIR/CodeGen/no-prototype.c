...
// CHECK: cir.func {{.*}} no_proto {{.*}} @noProto0(%arg{{[0-9]+}}: !s32i {{.+}}) -> !s32i
int test0(int x) {
...
// CHECK: cir.func {{.*}} @noProto1(%arg{{[0-9]+}}: !s32i {{.+}}) -> !s32i
int test1(int x) {
...
// CHECK: cir.func {{.*}} no_proto {{.*}} @noProto2(%arg{{[0-9]+}}: !s32i {{.+}}) -> !s32i
...
// CHECK: cir.func {{.*}} no_proto {{.*}} @noProto5(%arg{{[0-9]+}}: !s32i {{.+}}) -> !s32i
