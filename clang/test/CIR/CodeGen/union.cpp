...
// CIR:   %[[#BASE:]] = cir.get_member %0[0] {{.*}} : !cir.ptr<!rec_U> -> !cir.ptr<!cir.bool>
// CIR:   cir.store{{.*}} %{{.+}}, %[[#BASE]] : !cir.bool, !cir.ptr<!cir.bool>
// CIR:   cir.get_member %0[0] {{.*}} : !cir.ptr<!rec_U> -> !cir.ptr<!cir.bool>
// CIR:   %[[#BASE:]] = cir.get_member %0[2] {{.*}} : !cir.ptr<!rec_U> -> !cir.ptr<!s32i>
// CIR:   cir.store{{.*}} %{{.+}}, %[[#BASE]] : !s32i, !cir.ptr<!s32i>
// CIR:   %[[#BASE:]] = cir.get_member %0[2] {{.*}} : !cir.ptr<!rec_U> -> !cir.ptr<!s32i>
// CIR:   %[[#BASE:]] = cir.get_member %0[3] {{.*}} : !cir.ptr<!rec_U> -> !cir.ptr<!cir.float>
// CIR:   cir.store{{.*}} %{{.+}}, %[[#BASE]] : !cir.float, !cir.ptr<!cir.float>
// CIR:   %[[#BASE:]] = cir.get_member %0[3] {{.*}} : !cir.ptr<!rec_U> -> !cir.ptr<!cir.float>
// CIR:   %[[#BASE:]] = cir.get_member %0[4] {{.*}} : !cir.ptr<!rec_U> -> !cir.ptr<!cir.double>
