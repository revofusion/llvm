...
// CIR: cir.global "private" appending @llvm.compiler.used = #cir.const_array<[#cir.global_view<@f0>, #cir.global_view<@g0>, #cir.global_view<@a0>]> : !cir.array<!cir.ptr<!void> x 3>
