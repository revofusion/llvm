...
// CIR: cir.global "private" appending @llvm.compiler.used = #cir.const_array<[#cir.global_view<@_ZL2g1>, #cir.global_view<@_ZL2g2>, #cir.global_view<@g5>, #cir.global_view<@g6>, #cir.global_view<@_ZN12_GLOBAL__N_12s4E>, #cir.global_view<@_ZN2ST2s6E>]> : !cir.array<!cir.ptr<!void> x 6>
