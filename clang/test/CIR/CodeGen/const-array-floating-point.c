...
// CIR-DAG: cir.global external @ld_arr = #cir.const_array<[#cir.fp<1.000000e+00>, #cir.fp<-2.000000e+00>, #cir.fp<0.000000e+00>]> : !cir.array<!cir.long_double<!cir.f80> x 3>
// CIR-DAG: cir.global external @ld_zero = #cir.zero : !cir.array<!cir.long_double<!cir.f80> x 4>
// CIR-DAG: cir.global external @q_arr = #cir.const_array<[#cir.fp<1.000000e+00>, #cir.fp<-2.000000e+00>, #cir.fp<0.000000e+00>]> : !cir.array<!cir.f128 x 3>
// CIR-DAG: cir.global external @h_arr = #cir.const_array<[#cir.fp<1.000000e+00>, #cir.fp<-2.000000e+00>, #cir.fp<0.000000e+00>]> : !cir.array<!cir.f16 x 3>
// CIR-DAG: cir.global external @bf_arr = #cir.const_array<[#cir.fp<1.000000e+00>, #cir.fp<-2.000000e+00>, #cir.fp<0.000000e+00>]> : !cir.array<!cir.bf16 x 3>
// CIR-DAG: cir.global external @f_arr = #cir.const_array<[#cir.fp<1.000000e+00>, #cir.fp<-2.000000e+00>, #cir.fp<0.000000e+00>]> : !cir.array<!cir.float x 3>
// CIR-DAG: cir.global external @d_arr = #cir.const_array<[#cir.fp<1.000000e+00>, #cir.fp<-2.000000e+00>, #cir.fp<0.000000e+00>]> : !cir.array<!cir.double x 3>
