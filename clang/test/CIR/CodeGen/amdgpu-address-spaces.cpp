...
// CIR-PRE-DAG: cir.global external lang_address_space(offload_global) @globalArray = #cir.const_array<[#cir.int<1>, #cir.int<2>, #cir.int<3>, #cir.int<4>]> : !cir.array<!s32i x 4>{{.*}}
// CIR-DAG:     cir.global external target_address_space(1) @globalArray = #cir.const_array<[#cir.int<1>, #cir.int<2>, #cir.int<3>, #cir.int<4>]> : !cir.array<!s32i x 4>{{.*}}
...
// CIR-PRE-DAG: cir.global constant external lang_address_space(offload_constant) @constArray = #cir.const_array<[#cir.int<10>, #cir.int<20>, #cir.int<30>]> : !cir.array<!s32i x 3>{{.*}}
// CIR-DAG:     cir.global constant external target_address_space(4) @constArray = #cir.const_array<[#cir.int<10>, #cir.int<20>, #cir.int<30>]> : !cir.array<!s32i x 3>{{.*}}
