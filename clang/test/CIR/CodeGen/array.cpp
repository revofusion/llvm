...
// CIR: %[[TEMP:.*]] = cir.alloca !cir.ptr<!s32i>, !cir.ptr<!cir.ptr<!s32i>>, ["arrayinit.temp", init]
// CIR: %[[PTR:.*]] = cir.cast array_to_ptrdecay %[[ARR]] : !cir.ptr<!cir.array<!s32i x 2>> -> !cir.ptr<!s32i>
// CIR: %[[FIVE:.*]] = cir.const #cir.int<5> : !s32i
// CIR: cir.store align(4) %[[FIVE]], %[[PTR]] : !s32i, !cir.ptr<!s32i>
// CIR: %[[ONE:.*]] = cir.const #cir.int<1> : !s64i
// CIR: %[[NEXT:.*]] = cir.ptr_stride %[[PTR]], %[[ONE]] : (!cir.ptr<!s32i>, !s64i) -> !cir.ptr<!s32i>
// CIR: cir.store align(8) %[[NEXT]], %[[TEMP]] : !cir.ptr<!s32i>, !cir.ptr<!cir.ptr<!s32i>>
// CIR: %[[TWO:.*]] = cir.const #cir.int<2> : !s64i
// CIR: %[[END:.*]] = cir.ptr_stride %[[PTR]], %[[TWO]] : (!cir.ptr<!s32i>, !s64i) -> !cir.ptr<!s32i>
// CIR: cir.do {
// CIR:   %[[CUR:.*]] = cir.load align(8) %[[TEMP]] : !cir.ptr<!cir.ptr<!s32i>>, !cir.ptr<!s32i>
// CIR:   %[[ZERO:.*]] = cir.const #cir.int<0> : !s32i
// CIR:   cir.store align(4) %[[ZERO]], %[[CUR]] : !s32i, !cir.ptr<!s32i>
// CIR:   %[[ONE2:.*]] = cir.const #cir.int<1> : !s64i
// CIR:   %[[NEXT2:.*]] = cir.ptr_stride %[[CUR]], %[[ONE2]] : (!cir.ptr<!s32i>, !s64i) -> !cir.ptr<!s32i>
// CIR:   cir.store align(8) %[[NEXT2]], %[[TEMP]] : !cir.ptr<!s32i>, !cir.ptr<!cir.ptr<!s32i>>
// CIR:   cir.yield
// CIR: } while {
// CIR:   %[[CUR2:.*]] = cir.load align(8) %[[TEMP]] : !cir.ptr<!cir.ptr<!s32i>>, !cir.ptr<!s32i>
// CIR:   %[[CMP:.*]] = cir.cmp(ne, %[[CUR2]], %[[END]]) : !cir.ptr<!s32i>, !cir.bool
// CIR:   cir.condition(%[[CMP]])
// CIR: }

// LLVM: define{{.*}} void @_Z5func2v(){{.*}}
// LLVM:   %[[ARR:.*]] = alloca [2 x i32], i64 1, align 4
// LLVM:   %[[PTR:.*]] = getelementptr i32, ptr %[[ARR]], i32 0
// LLVM:   store i32 5, ptr %[[PTR]], align 4
...
// CIR: cir.store align(4) %[[SIX]], %[[NEXT]] : !s32i, !cir.ptr<!s32i>
// CIR: %[[IDX_V:.*]] = cir.const #cir.int<1> : !s32i
// CIR: cir.store align(4) %[[IDX_V]], %[[IDX]] : !s32i, !cir.ptr<!s32i>
// CIR: %[[TMP_IDX:.*]] = cir.load align(4) %[[IDX]] : !cir.ptr<!s32i>, !s32i
// CIR: %[[ELE_PTR:.*]] = cir.get_element %[[ARR]][%[[TMP_IDX]] : !s32i] : !cir.ptr<!cir.array<!s32i x 2>> -> !cir.ptr<!s32i>
// CIR: %[[ELE_TMP:.*]] = cir.load align(4) %[[ELE_PTR]] : !cir.ptr<!s32i>, !s32i
// CIR: cir.store align(4) %[[ELE_TMP]], %[[INIT]] : !s32i, !cir.ptr<!s32i>
...
// LLVM:  store i32 6, ptr %[[PTR2]], align 4
...
// CIR: %[[INIT:.*]] = cir.alloca !s32i, !cir.ptr<!s32i>, ["e", init]
// CIR: %[[ROW0:.*]] = cir.cast array_to_ptrdecay %[[ARR]] : !cir.ptr<!cir.array<!cir.array<!s32i x 1> x 2>> -> !cir.ptr<!cir.array<!s32i x 1>>
// CIR: %[[P0:.*]] = cir.cast array_to_ptrdecay %[[ROW0]] : !cir.ptr<!cir.array<!s32i x 1>> -> !cir.ptr<!s32i>
// CIR: %[[FIVE:.*]] = cir.const #cir.int<5> : !s32i
// CIR: cir.store align(4) %[[FIVE]], %[[P0]] : !s32i, !cir.ptr<!s32i>
// CIR: %[[ONE:.*]] = cir.const #cir.int<1> : !s64i
// CIR: %[[ROW1:.*]] = cir.ptr_stride %[[ROW0]], %[[ONE]] : (!cir.ptr<!cir.array<!s32i x 1>>, !s64i) -> !cir.ptr<!cir.array<!s32i x 1>>
// CIR: %[[P1:.*]] = cir.cast array_to_ptrdecay %[[ROW1]] : !cir.ptr<!cir.array<!s32i x 1>> -> !cir.ptr<!s32i>
// CIR: %[[SIX:.*]] = cir.const #cir.int<6> : !s32i
// CIR: cir.store align(4) %[[SIX]], %[[P1]] : !s32i, !cir.ptr<!s32i>
// CIR: %[[ZERO:.*]] = cir.const #cir.int<0> : !s32i
// CIR: %[[ONE2:.*]] = cir.const #cir.int<1> : !s32i
// CIR: %[[ARR_1:.*]] = cir.get_element %[[ARR]][%[[ONE2]] : !s32i] : !cir.ptr<!cir.array<!cir.array<!s32i x 1> x 2>> -> !cir.ptr<!cir.array<!s32i x 1>>
// CIR: %[[ELE_0:.*]] = cir.get_element %[[ARR_1]][%[[ZERO]] : !s32i] : !cir.ptr<!cir.array<!s32i x 1>> -> !cir.ptr<!s32i>
// CIR: %[[TMP:.*]] = cir.load align(4) %[[ELE_0]] : !cir.ptr<!s32i>, !s32i
// CIR: cir.store align(4) %[[TMP]], %[[INIT]] : !s32i, !cir.ptr<!s32i>

// LLVM: define{{.*}} void @_Z5func4v(){{.*}}
// LLVM:  %[[ARR:.*]] = alloca [2 x [1 x i32]], i64 1, align 4
// LLVM:  %[[INIT:.*]] = alloca i32, i64 1, align 4
// LLVM:  %[[ROW0:.*]] = getelementptr [1 x i32], ptr %[[ARR]], i32 0
// LLVM:  %[[E00:.*]] = getelementptr i32, ptr %[[ROW0]], i32 0
// LLVM:  store i32 5, ptr %[[E00]], align 4
// LLVM:  %[[ROW1:.*]] = getelementptr [1 x i32], ptr %[[ROW0]], i64 1
// LLVM:  %[[E10:.*]] = getelementptr i32, ptr %[[ROW1]], i32 0
// LLVM:  store i32 6, ptr %[[E10]], align 4
...
// CIR: %[[ARR:.*]] = cir.alloca !cir.array<!cir.array<!s32i x 1> x 2>, !cir.ptr<!cir.array<!cir.array<!s32i x 1> x 2>>, ["arr", init]
// CIR: %[[TEMP:.*]] = cir.alloca !cir.ptr<!cir.array<!s32i x 1>>, !cir.ptr<!cir.ptr<!cir.array<!s32i x 1>>>, ["arrayinit.temp", init]
// CIR: %[[ROW0:.*]] = cir.cast array_to_ptrdecay %[[ARR]] : !cir.ptr<!cir.array<!cir.array<!s32i x 1> x 2>> -> !cir.ptr<!cir.array<!s32i x 1>>
// CIR: %[[P0:.*]] = cir.cast array_to_ptrdecay %[[ROW0]] : !cir.ptr<!cir.array<!s32i x 1>> -> !cir.ptr<!s32i>
// CIR: %[[FIVE:.*]] = cir.const #cir.int<5> : !s32i
// CIR: cir.store align(4) %[[FIVE]], %[[P0]] : !s32i, !cir.ptr<!s32i>
// CIR: %[[ONE:.*]] = cir.const #cir.int<1> : !s64i
// CIR: %[[NEXT:.*]] = cir.ptr_stride %[[ROW0]], %[[ONE]] : (!cir.ptr<!cir.array<!s32i x 1>>, !s64i) -> !cir.ptr<!cir.array<!s32i x 1>>
// CIR: cir.store align(8) %[[NEXT]], %[[TEMP]] : !cir.ptr<!cir.array<!s32i x 1>>, !cir.ptr<!cir.ptr<!cir.array<!s32i x 1>>>
// CIR: %[[TWO:.*]] = cir.const #cir.int<2> : !s64i
// CIR: %[[END:.*]] = cir.ptr_stride %[[ROW0]], %[[TWO]] : (!cir.ptr<!cir.array<!s32i x 1>>, !s64i) -> !cir.ptr<!cir.array<!s32i x 1>>
// CIR: cir.do {
// CIR:   %[[CUR:.*]] = cir.load align(8) %[[TEMP]] : !cir.ptr<!cir.ptr<!cir.array<!s32i x 1>>>, !cir.ptr<!cir.array<!s32i x 1>>
// CIR:   %[[ZERO_ARR:.*]] = cir.const #cir.zero : !cir.array<!s32i x 1>
// CIR:   cir.store align(4) %[[ZERO_ARR]], %[[CUR]] : !cir.array<!s32i x 1>, !cir.ptr<!cir.array<!s32i x 1>>
// CIR:   %[[ONE2:.*]] = cir.const #cir.int<1> : !s64i
// CIR:   %[[NEXT2:.*]] = cir.ptr_stride %[[CUR]], %[[ONE2]] : (!cir.ptr<!cir.array<!s32i x 1>>, !s64i) -> !cir.ptr<!cir.array<!s32i x 1>>
// CIR:   cir.store align(8) %[[NEXT2]], %[[TEMP]] : !cir.ptr<!cir.array<!s32i x 1>>, !cir.ptr<!cir.ptr<!cir.array<!s32i x 1>>>
// CIR:   cir.yield
// CIR: } while {
// CIR:   %[[CUR2:.*]] = cir.load align(8) %[[TEMP]] : !cir.ptr<!cir.ptr<!cir.array<!s32i x 1>>>, !cir.ptr<!cir.array<!s32i x 1>>
// CIR:   %[[CMP:.*]] = cir.cmp(ne, %[[CUR2]], %[[END]]) : !cir.ptr<!cir.array<!s32i x 1>>, !cir.bool
// CIR:   cir.condition(%[[CMP]])
// CIR: }
...
// LLVM:   %[[E00:.*]] = getelementptr i32, ptr %[[ROW0]], i32 0
// LLVM:   store i32 5, ptr %[[E00]], align 4
// LLVM:   store [1 x i32] zeroinitializer, ptr %{{.*}}, align 4
...
// CIR: %[[PTR:.*]] = cir.cast array_to_ptrdecay %[[ARR_ADDR]] : !cir.ptr<!cir.array<!cir.complex<!cir.float> x 2>> -> !cir.ptr<!cir.complex<!cir.float>>
// CIR: %[[C1:.*]] = cir.const #cir.const_complex<#cir.fp<1.100000e+00> : !cir.float, #cir.fp<2.200000e+00> : !cir.float> : !cir.complex<!cir.float>
// CIR: cir.store align(8) %[[C1]], %[[PTR]] : !cir.complex<!cir.float>, !cir.ptr<!cir.complex<!cir.float>>
// CIR: %[[ONE:.*]] = cir.const #cir.int<1> : !s64i
// CIR: %[[PTR2:.*]] = cir.ptr_stride %[[PTR]], %[[ONE]] : (!cir.ptr<!cir.complex<!cir.float>>, !s64i) -> !cir.ptr<!cir.complex<!cir.float>>
// CIR: %[[C2:.*]] = cir.const #cir.const_complex<#cir.fp<3.300000e+00> : !cir.float, #cir.fp<4.400000e+00> : !cir.float> : !cir.complex<!cir.float>
// CIR: cir.store align(8) %[[C2]], %[[PTR2]] : !cir.complex<!cir.float>, !cir.ptr<!cir.complex<!cir.float>>

// LLVM: %[[ARR_ADDR:.*]] = alloca [2 x { float, float }], i64 1, align 16
// LLVM: %[[PTR:.*]] = getelementptr { float, float }, ptr %[[ARR_ADDR]], i32 0
// LLVM: store { float, float } { float 0x3FF19999A0000000, float 0x40019999A0000000 }, ptr %[[PTR]], align 8
// LLVM: %[[PTR2:.*]] = getelementptr { float, float }, ptr %[[PTR]], i64 1
// LLVM: store { float, float } { float 0x400A666660000000, float 0x40119999A0000000 }, ptr %[[PTR2]], align 8
