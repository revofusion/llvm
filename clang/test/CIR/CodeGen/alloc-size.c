...
// CIR: cir.func{{.*}}@my_malloc(!s32i {{.*llvm.noundef.*}}) -> !cir.ptr<!void> attributes {{.*allocsize = array<i32: 0>.*}}
extern void *my_malloc(int) __attribute__((alloc_size(1)));
// CIR: cir.func{{.*}}@my_calloc(!s32i {{.*llvm.noundef.*}}, !s32i {{.*llvm.noundef.*}}) -> !cir.ptr<!void> attributes {{.*allocsize = array<i32: 0, 1>.*}}
