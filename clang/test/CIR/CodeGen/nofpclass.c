...
// CIR: cir.func {{.*}} @identity(%arg0: !cir.float {{.*llvm.nofpclass = 519 : i64.*llvm.noundef.*}} loc({{.*}}))
...
// CIR: cir.func {{.*}} @add(%arg0: !cir.double {{.*llvm.nofpclass = 519 : i64.*llvm.noundef.*}} loc({{.*}}), %arg1: !cir.double {{.*llvm.nofpclass = 519 : i64.*llvm.noundef.*}} loc({{.*}}))
...
// CIR: cir.func {{.*}} @non_fp(%arg0: !s32i {{.*llvm.noundef.*}} loc({{.*}})) -> !s32i
