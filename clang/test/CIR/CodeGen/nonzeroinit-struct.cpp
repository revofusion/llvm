...
// CIR-AFTER-DAG: !rec_anon_struct = !cir.struct<{!u64i, !s64i}>
...
// CIR-AFTER-DAG: cir.global "private" constant cir_private @__const.local.localT_init = #cir.const_record<{#cir.int<1>, #cir.fp<2.200000e+00>, #cir.int<0>}> : !rec_Trivial
// CIR-AFTER-DAG: cir.global "private" constant cir_private @__const.local.localMpt_init = #cir.const_record<{#cir.int<1>, #cir.fp<2.000000e+00>, #cir.const_record<{#cir.global_view<@_ZN5Other4funcEif>, #cir.int<0>}> : !rec_anon_struct}> : !rec_WithMemPtr
...
// CIR-BEFORE-DAG: cir.global external @mpt_init = #cir.const_record<{#cir.int<1>, #cir.fp<2.000000e+00>, #cir.method<@_ZN5Other4funcEif>}> : !rec_WithMemPtr {alignment = 8 : i64}
// CIR-AFTER-DAG: cir.global external @mpt_init = #cir.const_record<{#cir.int<1>, #cir.fp<2.000000e+00>, #cir.const_record<{#cir.global_view<@_ZN5Other4funcEif>, #cir.int<0>}> : !rec_anon_struct}> : !rec_WithMemPtr {alignment = 8 : i64}
...
Trivial t;
// CIR-BEFORE-DAG: cir.global external @t = #cir.const_record<{#cir.int<0>, #cir.fp<0.000000e+00>, #cir.data_member<null>}> : !rec_Trivial {alignment = 8 : i64}
// CIR-AFTER-DAG: cir.global external @t = #cir.const_record<{#cir.int<0>, #cir.fp<0.000000e+00>, #cir.int<-1>}> : !rec_Trivial {alignment = 8 : i64}
// LLVM-DAG: @t = global %struct.Trivial { i32 0, double 0.000000e+00, i64 -1 }, align 8

Trivial t_init{1,2.2, &Other::x};
// CIR-BEFORE-DAG: cir.global external @t_init = #cir.const_record<{#cir.int<1>, #cir.fp<2.200000e+00>, #cir.data_member<0>}> : !rec_Trivial {alignment = 8 : i64}
// CIR-AFTER-DAG: cir.global external @t_init = #cir.const_record<{#cir.int<1>, #cir.fp<2.200000e+00>, #cir.int<0>}> : !rec_Trivial {alignment = 8 : i64}
...
// CIR-BEFORE: %[[MPT_INIT_VAL:.*]] = cir.const #cir.const_record<{#cir.int<1>, #cir.fp<2.000000e+00>, #cir.method<@_ZN5Other4funcEif>}> : !rec_WithMemPtr
...
// CIR-BEFORE: %[[T_INIT_VAL:.*]] = cir.const #cir.const_record<{#cir.int<1>, #cir.fp<2.200000e+00>, #cir.data_member<0>}> : !rec_Trivial
