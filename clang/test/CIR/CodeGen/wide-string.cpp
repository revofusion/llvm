...
// CIR: cir.global external @some_array = #cir.const_array<[#cir.int<97>], trailing_zeros> : !cir.array<!u16i x 10>
...
// CIR: cir.global "private" constant cir_private dso_local @{{.+}} = #cir.const_array<[#cir.int<20320>, #cir.int<22909>, #cir.int<19990>, #cir.int<30028>], trailing_zeros> : !cir.array<!u16i x 5>
...
// CIR: cir.global "private" constant cir_private dso_local @{{.+}} = #cir.const_array<[#cir.int<20320>, #cir.int<22909>, #cir.int<19990>, #cir.int<30028>], trailing_zeros> : !cir.array<!u32i x 5>
...
// CIR: cir.global "private" constant cir_private dso_local @{{.+}} = #cir.const_array<[#cir.int<49>, #cir.int<50>, #cir.int<51>, #cir.int<52>], trailing_zeros> : !cir.array<!s32i x 5>
...
// CIR: cir.global "private" constant cir_private dso_local @{{.+}} = #cir.const_array<[#cir.int<116>, #cir.int<101>, #cir.int<115>, #cir.int<116>], trailing_zeros> : !cir.array<!u16i x 5>
