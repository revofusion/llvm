...
// CIR: cir.global "private" constant internal @_ZGR2sr_ = #cir.const_record<{#cir.global_view<@_ZGR2sr_, [1 : i32]>, #cir.const_array<[#cir.int<1>, #cir.int<2>, #cir.int<3>]>}> : !rec_anon_struct
...
// CIR: cir.global "private" constant internal @_ZGR3msr_ = #cir.const_record<{#cir.global_view<@_ZGR3msr_, [2 : i32]>, #cir.global_view<@_ZGR3msr_, [2 : i32]>, #cir.const_array<[#cir.int<1>, #cir.int<2>, #cir.int<3>]>}> : !rec_anon_struct1
