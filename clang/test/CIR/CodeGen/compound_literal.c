...
int *p1 = (int[]){1, 2, 3};
// CIR: cir.global "private" internal @".compoundliteral" = #cir.const_array<[#cir.int<1>, #cir.int<2>, #cir.int<3>]> : !cir.array<!s32i x 3> {alignment = 4 : i64}
...
// CIR: cir.global "private" internal @".compoundliteral.2" = #cir.const_record<{#cir.int<5>, #cir.int<10>}> : !rec_S {alignment = 4 : i64}
...
// CIR: cir.global "private" internal @".compoundliteral.3" = #cir.const_array<[#cir.int<1>, #cir.int<2>]> : !cir.array<!s32i x 2> {alignment = 4 : i64}
// CIR: cir.global "private" internal @".compoundliteral.4" = #cir.const_array<[#cir.int<3>, #cir.int<4>]> : !cir.array<!s32i x 2> {alignment = 4 : i64}
// CIR: cir.global external @p4 = #cir.const_array<[#cir.global_view<@".compoundliteral.3">, #cir.global_view<@".compoundliteral.4">]> : !cir.array<!cir.ptr<!s32i> x 2> {alignment = 16 : i64}
...
// CIR: cir.global "private" internal @".compoundliteral.5" = #cir.const_array<[#cir.int<10>, #cir.int<20>]> : !cir.array<!s32i x 2> {alignment = 4 : i64}
// CIR: cir.global external @p5 = #cir.const_record<{#cir.global_view<@".compoundliteral.5">}> : !rec_W {alignment = 8 : i64}
...
// CIR: cir.global "private" constant internal @".compoundliteral.6" = #cir.const_array<[#cir.int<1>, #cir.int<2>, #cir.int<3>]> : !cir.array<!s32i x 3> {alignment = 4 : i64}
...
// CIR: cir.global "private" internal @".compoundliteral.8" = #cir.const_array<[#cir.int<10>, #cir.int<20>, #cir.int<30>]> : !cir.array<!s32i x 3> {alignment = 4 : i64}
...
// CIR: cir.global "private" internal @".compoundliteral.9" = #cir.const_array<[#cir.global_view<@x>, #cir.global_view<@x>]> : !cir.array<!cir.ptr<!s32i> x 2> {alignment = 8 : i64}
