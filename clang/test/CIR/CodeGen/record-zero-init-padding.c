...
// Type definitions for structs with padding
// CIR-DAG: !rec_padding_after_field = !cir.record<struct "padding_after_field" {!s8i, !s32i}>
// CIR-DAG: !rec_bitfield_with_padding = !cir.record<struct "bitfield_with_padding" {!u8i, !s32i}>
// CIR-DAG: !rec_tail_padding = !cir.record<struct "tail_padding" {!s32i, !s8i}>
// CIR-DAG: !rec_multiple_padding = !cir.record<struct "multiple_padding" {!s8i, !s16i, !s64i}>

// paf: char + int (padding now implicit in the record layout)
...
// bfp: unsigned bitfield byte + int (padding now implicit)
...
// tp: int + char (tail padding now implicit)
...
// mp: char + short + long long (padding now implicit)
...
// LLVM-DAG: @test_zero_init_padding.paf = internal constant %struct.padding_after_field { i8 1, i32 42 }, align 4
// LLVM-DAG: @test_zero_init_padding.bfp = internal constant %struct.bitfield_with_padding { i8 17, i32 99 }, align 4
// LLVM-DAG: @test_zero_init_padding.tp = internal constant %struct.tail_padding { i32 10, i8 20 }, align 4
// LLVM-DAG: @test_zero_init_padding.mp = internal constant %struct.multiple_padding { i8 5, i16 10, i64 100 }, align 8
