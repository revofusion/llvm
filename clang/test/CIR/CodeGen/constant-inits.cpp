...
void function() {
    ...
    constexpr static unsigned __int128 wide_int =
        (static_cast<unsigned __int128>(1) << 100) + 7;
...
// Storage type definitions for bitfields
// CIR-DAG: !rec_byte_aligned_bitfields = !cir.record<struct "byte_aligned_bitfields" {!u32i}>
// CIR-DAG: !rec_partial_bitfields = !cir.record<struct "partial_bitfields" padded {!u16i, !cir.array<!u8i x 2>}>
// CIR-DAG: !rec_signed_byte_aligned_bitfields = !cir.record<struct "signed_byte_aligned_bitfields" padded {!u16i, !cir.array<!u8i x 2>}>
...
// CIR-DAG: cir.global "private" constant internal dso_local @_ZZ8functionvE8wide_int = #cir.int<1267650600228229401496703205383> : !u128i
...
// CIR-DAG-SAME:   #cir.int<32767> : !u16i,
// CIR-DAG-SAME:   #cir.const_array<[#cir.zero : !u8i, #cir.zero : !u8i]> : !cir.array<!u8i x 2>
// CIR-DAG-SAME: }> : !rec_signed_byte_aligned_bitfields
...
// CIR-DAG-SAME:   #cir.int<785> : !u16i,
// CIR-DAG-SAME:   #cir.const_array<[#cir.zero : !u8i, #cir.zero : !u8i]> : !cir.array<!u8i x 2>
// CIR-DAG-SAME: }> : !rec_partial_bitfields
