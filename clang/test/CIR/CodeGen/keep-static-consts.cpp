...
// CIR: cir.global "private" appending @llvm.compiler.used = #cir.const_array<[#cir.global_view<@_ZL7srcvers>, #cir.global_view<@b>, #cir.global_view<@_ZL8srcvers2>, #cir.global_view<@_ZL1N>]> : !cir.array<!cir.ptr<!void> x 4>
