...
// CIR-DAG: cir.global "private" constant cir_private @__const._Z3fooIJ2S12S22S3EEDav.values = #cir.const_array<[#cir.int<1>, #cir.int<2>, #cir.int<3>, #cir.int<0>]> : !cir.array<!s32i x 4>
