...
// CIR: cir.global "private" external @_ZTV6Struct = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI6Struct>, #cir.global_view<@__cxa_pure_virtual>, #cir.global_view<@__cxa_deleted_virtual>, #cir.global_view<@_ZN6Struct2f3Ev>]> : !cir.array<!cir.ptr<!u8i> x 5>}> : !rec_anon_struct1 {{.*}}
