...
// CIR-DAG: cir.global "private" linkonce_odr comdat @_ZTV1C = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.ptr<null>, #cir.ptr<null>, #cir.global_view<@_ZTI1C>, #cir.global_view<@_ZN1C1fEv>]> : !cir.array<!cir.ptr<!u8i> x 5>}> : !{{.*}}{alignment = 8 : i64}
...
// CIR-DAG: cir.global linkonce_odr comdat @_ZTT1C = #cir.const_array<[#cir.global_view<@_ZTV1C, [0 : i32, 4 : i32]>, #cir.global_view<@_ZTV1C, [0 : i32, 4 : i32]>]> : !cir.array<!cir.ptr<!u8i> x 2> {alignment = 8 : i64}
...
// CIR-DAG: cir.global "private" external @_ZTV1D = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI1D>, #cir.global_view<@_ZN1D1fEv>]> : !cir.array<!cir.ptr<!u8i> x 3>}> : !{{.*}}{alignment = 8 : i64}
...
// linkage.
// CIR-DAG: cir.global "private" external @_ZTV1EIcE = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI1EIcE>, #cir.global_view<@_ZN1EIcE6anchorEv>]> : !cir.array<!cir.ptr<!u8i> x 3>}> : !{{.*}}{alignment = 8 : i64}
...
// weak_odr linkage.
// CIR-DAG: cir.global "private" weak_odr comdat @_ZTV1EIsE = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI1EIsE>, #cir.global_view<@_ZN1EIsED1Ev>, #cir.global_view<@_ZN1EIsED0Ev>]> : !cir.array<!cir.ptr<!u8i> x 4>}> : !{{.*}}{alignment = 8 : i64}
...
// CIR-DAG: cir.global "private" weak_odr comdat @_ZTV1FIsE = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI1FIsE>, #cir.global_view<@_ZN1FIsE3fooEv>]> : !cir.array<!cir.ptr<!u8i> x 3>}> : !{{.*}}{alignment = 8 : i64}
...
// CIR-DAG: cir.global "private" linkonce_odr comdat @_ZTV1EIlE = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI1EIlE>, #cir.global_view<@_ZN1EIlED1Ev>, #cir.global_view<@_ZN1EIlED0Ev>]> : !cir.array<!cir.ptr<!u8i> x 4>}> : !{{.*}}{alignment = 8 : i64}
...
// CIR-DAG: cir.global "private" linkonce_odr comdat @_ZTV1FIlE = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI1FIlE>, #cir.global_view<@_ZN1FIlE3fooEv>]> : !cir.array<!cir.ptr<!u8i> x 3>}> : !{{.*}}{alignment = 8 : i64}
...
// internal linkage.
// CIR-DAG: cir.global "private" internal dso_local @_ZTV3$_0 = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI3$_0>, #cir.global_view<@_ZN1D1fEv>]> : !cir.array<!cir.ptr<!u8i> x 3>}> : !{{.*}}{alignment = 8 : i64}
...
// namespace.
// CIR-DAG: cir.global "private" internal dso_local @_ZTVN12_GLOBAL__N_11AE = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTIN12_GLOBAL__N_11AE>, #cir.global_view<@_ZN12_GLOBAL__N_11A1fEv>]> : !cir.array<!cir.ptr<!u8i> x 3>}> : !{{.*}}{alignment = 8 : i64}
...
// CIR-DAG: cir.global "private" linkonce_odr comdat @_ZTV1FIcE = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI1FIcE>, #cir.global_view<@_ZN1FIcE3fooEv>]> : !cir.array<!cir.ptr<!u8i> x 3>}> : !{{.*}}{alignment = 8 : i64}
...
// CIR-DAG: cir.global "private" linkonce_odr comdat @_ZTV1GIiE = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI1GIiE>, #cir.global_view<@_ZN1GIiE2f0Ev>, #cir.global_view<@_ZN1GIiE2f1Ev>]> : !cir.array<!cir.ptr<!u8i> x 4>}> : !{{.*}}{alignment = 8 : i64}
...
// CIR-DAG: cir.global "private" linkonce_odr comdat @_ZTV1HIiE = #cir.vtable<{#cir.const_array<[#cir.ptr<null>, #cir.global_view<@_ZTI1HIiE>, #cir.global_view<@_ZN1HIiED1Ev>, #cir.global_view<@_ZN1HIiED0Ev>]> : !cir.array<!cir.ptr<!u8i> x 4>}> : !{{.*}}{alignment = 8 : i64}
