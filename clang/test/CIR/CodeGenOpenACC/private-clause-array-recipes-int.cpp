...
// CHECK-NEXT: ^bb0(%[[ARG:.*]]: !cir.ptr<!cir.array<!cir.array<!s32i x 5> x 5>>, %[[BOUND1:.*]]: !acc.data_bounds_ty, %[[BOUND2:.*]]: !acc.data_bounds_ty):
...
// CHECK-NEXT: ^bb0(%[[ARG:.*]]: !cir.ptr<!cir.array<!cir.array<!s32i x 5> x 5>>):
