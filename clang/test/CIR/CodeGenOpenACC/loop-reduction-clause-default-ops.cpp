...
// CHECK-NEXT: ^bb0(%[[ARG:.*]]: !cir.ptr<!rec_DefaultOperators>{{.*}})
// CHECK-NEXT: %[[ALLOCA:.*]] = cir.alloca "openacc.reduction.init" {{.*}} init : !cir.ptr<!rec_DefaultOperators>
// CHECK-NEXT: %[[CONST:.*]] = cir.const #cir.const_record<{{.*}}> : !rec_DefaultOperators {{.*}}
...
// CHECK-NEXT: ^bb0(%[[ARG:.*]]: !cir.ptr<!rec_DefaultOperators>{{.*}})
// CHECK-NEXT: %[[ALLOCA:.*]] = cir.alloca "openacc.reduction.init" {{.*}} init : !cir.ptr<!rec_DefaultOperators>
// CHECK-NEXT: %[[CONST:.*]] = cir.const #cir.const_record<{#cir.int<-2147483648>, #cir.int<0>, #cir.fp<-3.4{{.*}}E+38>, #cir.fp<-1.7{{.*}}E+308>, #false}> : !rec_DefaultOperators
// CHECK-NEXT: cir.store{{.*}} %[[CONST]], %[[ALLOCA]] : !rec_DefaultOperators, !cir.ptr<!rec_DefaultOperators>
// CHECK-NEXT: acc.yield
//
// CHECK-NEXT: } combiner {
...
// CHECK-NEXT: ^bb0(%[[ARG:.*]]: !cir.ptr<!rec_DefaultOperators>{{.*}})
// CHECK-NEXT: %[[ALLOCA:.*]] = cir.alloca "openacc.reduction.init" {{.*}} init : !cir.ptr<!rec_DefaultOperators>
// CHECK-NEXT: %[[CONST:.*]] = cir.const #cir.const_record<{#cir.int<2147483647>, #cir.int<4294967295>, #cir.fp<3.4{{.*}}E+38>, #cir.fp<1.7{{.*}}E+308>, #true}> : !rec_DefaultOperators
// CHECK-NEXT: cir.store{{.*}} %[[CONST]], %[[ALLOCA]] : !rec_DefaultOperators, !cir.ptr<!rec_DefaultOperators>
// CHECK-NEXT: acc.yield
//
// CHECK-NEXT: } combiner {
...
// CHECK-NEXT: %[[CONST:.*]] = cir.const #cir.const_record<{#cir.int<-1>, #cir.int<4294967295>, #true}> : !rec_DefaultOperatorsNoFloats
...
// CHECK-NEXT: ^bb0(%[[ARG:.*]]: !cir.ptr<!rec_DefaultOperators>{{.*}})
// CHECK-NEXT: %[[ALLOCA:.*]] = cir.alloca "openacc.reduction.init" {{.*}} init : !cir.ptr<!rec_DefaultOperators>
// CHECK-NEXT: %[[CONST:.*]] = cir.const #cir.const_record<{#cir.int<1>, #cir.int<1>, #cir.fp<1{{.*}}>, #cir.fp<1{{.*}}>, #true}> : !rec_DefaultOperators
// CHECK-NEXT: cir.store{{.*}} %[[CONST]], %[[ALLOCA]] : !rec_DefaultOperators, !cir.ptr<!rec_DefaultOperators>
// CHECK-NEXT: acc.yield
//
// CHECK-NEXT: } combiner {
